...
const UserCouponsPage = () => {
    ...
    Alert.alert(
      ...
      [
        ...
        { 
          text: "Apply", 
          onPress: () => {
            Alert.alert("Success", `Coupon ${coupon.code} has been applied to your cart.`);
            navigation.navigate('BuyDronePage');
          }
        }
      ]
    );
  ...
  const getExpiryStatus = (validUntil) => {
    ...
    if (daysRemaining < 5) return { text: `Expires in ${daysRemaining} days`, color: '#FF9800' };
    return { text: `Valid until ${new Date(validUntil).toLocaleDateString()}`, color: '#4CAF50' };
  };
      ...
      return (
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyTitle}>
            {activeTab === 'available' ? 'No Available Coupons' : 'No Used Coupons'}
          </Text>
          ...
          {activeTab === 'available' && (
            <TouchableOpacity 
              ...
              onPress={() => navigation.navigate('BuyDronePage')}
            >
                ...
                <View style={styles.termsContainer}>
                  {coupon.minPurchase !== 'None' && (
                    <View style={styles.termItem}>
                      ...
                      <Text style={styles.termText}>Min: {coupon.minPurchase}</Text>
                    </View>
                  )}
                  ...
                  {coupon.maxDiscount !== 'N/A' && (
                    <View style={styles.termItem}>
                      ...
                      <Text style={styles.termText}>Max: {coupon.maxDiscount}</Text>
                    </View>
                  )}
                </View>
              </View>
